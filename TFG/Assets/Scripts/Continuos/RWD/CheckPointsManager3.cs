...
public class CheckPointsManager3 : MonoBehaviour
{
    [SerializeField] private Agente4 kartAgent;

    // Checkpoint actual
    public CheckPoint2 nextCheckPointToReach { get; private set; }
    ...
    private List<CheckPoint2> Checkpoints;

    [SerializeField] public CheckPoints2 checkpp;

    private CheckPoint2 lastCheckpoint;

    // Evento opcional, si quieres notificar al agente al llegar a un checkpoint
    public event Action<CheckPoint2> reachedCheckpoint;
    ...
    public void CheckPointReached(CheckPoint2 checkpoint)
    {
